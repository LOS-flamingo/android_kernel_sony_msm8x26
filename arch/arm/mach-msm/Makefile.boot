...
dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-yukon_flamingo-GINA.dtb
dtb-$(CONFIG_ARCH_MSM8226)	+= msm8226-v2-yukon_flamingo-RITA.dtb
dtb-$(CONFIG_ARCH_MSM8226)	+= msm8226-v2-yukon_flamingo-REX.dtb
